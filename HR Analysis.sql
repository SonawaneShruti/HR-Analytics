...
from hr_1 h1 join hr_2 h2 on h1.employeenumber = h2.EmployeeId
...
Select DistanceFromHome, round(count(attrition)/(select count(employeenumber) from hr_1)*100,2) attrition_rate from hr_1
where attrition = 'Yes'
